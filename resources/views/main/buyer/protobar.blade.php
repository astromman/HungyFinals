...
<div class="progress-wrapper">
    <div class="progress-container">
        <!-- Step Circles -->
        <div class="steps">
            <span class="circle {{ isset($order) && ($order->order_status == 'Pending' || $order->order_status == 'At Cart') ? 'active' : '' }}">
                1
            </span>
            <span class="circle {{ isset($order) && $order->order_status == 'Preparing' ? 'active' : '' }}">
                2
            </span>
        ...
        <div class="step-text-container">
            ...
            <span class="step-text">Pick-up</span>
        </div>
    </div>
</div>
...
<style>
    ...
    .steps .circle {
        ...
        z-index: 2; /* Ensure circles are above the progress bar */
    }
    ...
    .steps .progress-bar {
        ...
        width: 100%;
        background: #e0e0e0;
        top: 50%; /* Align with the center of the circles */
        z-index: 1;
    }
    ...
    .step-text {
        ...
        font-weight: 500;
        color: #666;
        width: 50px; /* Ensure text aligns under the circle */
    }
</style>
