@extends('layouts.buyer.guestmaster')
...
<div class="container">
    ...
    <div class="row featurette align-items-center">
        <div class="col-12 text-center">
            ...
            <p class="sub-text">Transform your school meals with our convenient food ordering system. From hearty breakfasts to nutritious lunches, our menu offers a variety of delicious options to fuel your day, making school dining a breeze.</p>
        </div>
    </div>
    <hr class="featurette-divider">
    <div class="row featurette align-items-center">
        <div class="col-12 text-center order-md-2">
            ...
            <p class="sub-text">Experience the ease of our school canteen's food ordering system. With a wide range of tasty and wholesome dishes, we ensure that every meal is a delightful experience, catering to all your cravings and dietary needs.</p>
        </div>
    </div>
    <hr class="featurette-divider">
    <div class="row featurette align-items-center">
        <div class="col-12 text-center">
            ...
            <p class="sub-text">Our school canteen's food ordering system brings a world of flavors to your daily routine. From balanced meals to tasty snacks, we provide a convenient way to enjoy fresh and healthy food, supporting your well-being and academic success.</p>
        </div>
    </div>
    <hr class="featurette-divider">
</div>
