...
<head>
    ...
    * {
    ...
    .container::before {
        ...
        height: 2000px;
        border-radius: 50%;
        background-image: linear-gradient(-45deg, #0077B6, #0077B6);
        top: -10%;
        right: 48%;
    ...
    <div class="container">
                ...
                <form action="{{ route('register.post') }}" method="POST" class="sign-up-form">
                    ...
                    <div class="row">
                        ...
                        <div class="flex" style="flex-direction: column;">
                            ...
                            <div class="input-field">
                                <i class="fas fa-user"></i>
                                <input name="contact_num" type="text" placeholder="Mobile Number">
                            </div>
                        </div>
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                ...
                <img src="{{ asset('images/1.png') }}" class="image" alt="">
            </div>
